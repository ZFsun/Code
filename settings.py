...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ['*', '127.0.0.1', '149.129.54.45']
...
# STATIC_ROOT = os.path.join(SITE_ROOT, 'collectedstatic') # 静态文件在root下的项目文件中，nginx无法进入root
...
ADMINS = [('liangliang', '499428970@qq.com')]
# 微信管理员密码(两次md5获得)
